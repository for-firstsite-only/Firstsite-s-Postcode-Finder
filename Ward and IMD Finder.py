...
def load_postcode_data():
    df = pd.read_csv(r"C:\Users\Aishwarya\Downloads\HF postcode tool\Colchester postcodes.csv")
...
@st.cache_data
def load_imd_data():
    imd_df = pd.read_csv(r"C:\Users\Aishwarya\Downloads\HF postcode tool\imd_scores.csv")
    imd_df = imd_df[[
        "LSOA code (2011)", 
